...
void templ_ex1() {
  ...
  std::cout << std::format("a: {} - b: {} - c: {} - mean(a, b, c): {}\n",
      a, b, c, mean(a, b, c));
...
void templ_ex2() {
  ...
  // add & display
  std::println("p1: {} - p2: {} - p3: {} - p1+p2+p3: {}",
      p1, p2, p3, add_values(p1, p2, p3));
  ...
  // measuring distance
  std::println("p2: {} - p2.distance(): {} [{}]", 
      p2, p2.distance(), sqrt(std::pow(p2.X(),2)+std::pow(p2.Y(),2)));
