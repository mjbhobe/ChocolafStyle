...
const QString WindowTitle = QString(
    "Qt %1 Doodle - Step07: Adding Actions + Menus + handlers")
                                .arg(QT_VERSION_STR);
